const Button = ({
  ...
  const variants = {
    primary: 'bg-primary-600 text-white shadow-sm shadow-primary-900/10 hover:bg-primary-700 focus:ring-primary-500 disabled:bg-primary-300',
    secondary: 'bg-sand-100 text-dark-900 hover:bg-sand-200 focus:ring-sand-400 disabled:bg-sand-100',
    outline: 'border border-primary-600 bg-white text-primary-700 hover:bg-primary-50 focus:ring-primary-500 disabled:border-primary-300 disabled:text-primary-300',
    ghost: 'text-primary-700 hover:bg-primary-50 focus:ring-primary-500 disabled:text-primary-300',
