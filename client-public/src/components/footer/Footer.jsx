  ...
  return (
    <footer className="bg-dark-900 text-white">
      <div className="section-container py-16 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-[1.05fr_1.45fr] lg:gap-14">
          <div>
            <Link to={ROUTES.HOME} className="inline-flex items-center gap-3">
              ...
              <span>
                <span className="block font-display text-xl font-bold">Bablons Travel</span>
            ...
            <div className="mt-6 space-y-2.5 text-sm text-white/65">
              <p className="flex items-center gap-3">
                <FaPhoneAlt className="shrink-0 text-accent-300" />
                +1-800-TRAVEL-1
              </p>
              <p className="flex items-center gap-3">
                <MdEmail className="shrink-0 text-accent-300" />
                info@bablonstravelent.com
              </p>
              <p className="flex items-start gap-3">
                <FaMapMarkerAlt className="mt-0.5 shrink-0 text-accent-300" />
              ...
              {socialLinks.map((link) => {
                ...
                return (
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white transition hover:border-accent-300/40 hover:bg-primary-700"
          ...
          <div>
            <div className="grid gap-8 sm:grid-cols-3 sm:gap-6">
              {Object.entries(footerLinks).map(([category, links]) => (
                <div key={category}>
                  <h3 className="font-display text-lg font-bold text-white sm:text-xl">{category}</h3>
            ...
            <div className="mt-10 rounded-3xl border border-white/10 bg-white/[0.06] p-5 sm:p-6">
              <h3 className="font-display text-xl font-bold sm:text-2xl">Travel ideas, quietly delivered</h3>
              ...
              <form className="mt-4 flex flex-col gap-3 sm:mt-5 sm:flex-row">
                ...
                />
                <button type="button" className="h-12 shrink-0 rounded-full bg-secondary-600 px-6 text-sm font-bold text-white transition hover:bg-secondary-700">
                  Subscribe
                </button>
              </form>
            </div>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-white/10 pt-8 text-sm text-white/45 md:flex-row md:items-center md:justify-between">
          ...
          <p className="max-w-md md:text-right">Designed for travelers who expect the details to be handled.</p>
        </div>
      </div>
    </footer>
  )
